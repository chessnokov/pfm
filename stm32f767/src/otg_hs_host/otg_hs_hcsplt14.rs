...
pub struct R(crate::R<OTG_HS_HCSPLT14_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<OTG_HS_HCSPLT14_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<OTG_HS_HCSPLT14_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<OTG_HS_HCSPLT14_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `OTG_HS_HCSPLT14` writer"]
pub struct W(crate::W<OTG_HS_HCSPLT14_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<OTG_HS_HCSPLT14_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<OTG_HS_HCSPLT14_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<OTG_HS_HCSPLT14_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "OTG_HS host channel-14 split control register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [otg_hs_hcsplt14](index.html) module"]
pub struct OTG_HS_HCSPLT14_SPEC;
impl crate::RegisterSpec for OTG_HS_HCSPLT14_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [otg_hs_hcsplt14::R](R) reader structure"]
impl crate::Readable for OTG_HS_HCSPLT14_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [otg_hs_hcsplt14::W](W) writer structure"]
impl crate::Writable for OTG_HS_HCSPLT14_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets OTG_HS_HCSPLT14 to value 0"]
impl crate::Resettable for OTG_HS_HCSPLT14_SPEC {
    #[inline(always)]
