...
pub struct R(crate::R<S1M1AR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<S1M1AR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<S1M1AR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<S1M1AR_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `S1M1AR` writer"]
pub struct W(crate::W<S1M1AR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<S1M1AR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<S1M1AR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<S1M1AR_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "stream x memory 1 address register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [s1m1ar](index.html) module"]
pub struct S1M1AR_SPEC;
impl crate::RegisterSpec for S1M1AR_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [s1m1ar::R](R) reader structure"]
impl crate::Readable for S1M1AR_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [s1m1ar::W](W) writer structure"]
impl crate::Writable for S1M1AR_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets S1M1AR to value 0"]
impl crate::Resettable for S1M1AR_SPEC {
    #[inline(always)]
