...
pub struct W(crate::W<MDIOS_DOUTR22_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<MDIOS_DOUTR22_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<MDIOS_DOUTR22_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<MDIOS_DOUTR22_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `DOUT22` reader - Output data sent to MDIO Master during read frames"]
pub struct DOUT22_R(crate::FieldReader<u16, u16>);
impl DOUT22_R {
    #[inline(always)]
    pub(crate) fn new(bits: u16) -> Self {
        DOUT22_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for DOUT22_R {
