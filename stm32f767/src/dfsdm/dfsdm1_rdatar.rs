#[doc = "Register `DFSDM1_RDATAR` reader"]
pub struct R(crate::R<DFSDM1_RDATAR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<DFSDM1_RDATAR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<DFSDM1_RDATAR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<DFSDM1_RDATAR_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "DFSDM data register for the regular channel\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [dfsdm1_rdatar](index.html) module"]
pub struct DFSDM1_RDATAR_SPEC;
impl crate::RegisterSpec for DFSDM1_RDATAR_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [dfsdm1_rdatar::R](R) reader structure"]
impl crate::Readable for DFSDM1_RDATAR_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets DFSDM1_RDATAR to value 0"]
impl crate::Resettable for DFSDM1_RDATAR_SPEC {
    #[inline(always)]
