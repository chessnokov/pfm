...
pub struct R(crate::R<OTG_HS_GNPTXSTS_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<OTG_HS_GNPTXSTS_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<OTG_HS_GNPTXSTS_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<OTG_HS_GNPTXSTS_SPEC>) -> Self {
        R(reader)
    }
}
