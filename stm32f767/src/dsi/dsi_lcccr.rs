...
pub struct R(crate::R<DSI_LCCCR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<DSI_LCCCR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<DSI_LCCCR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<DSI_LCCCR_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "DSI Host LTDC Current Color Coding Register\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [dsi_lcccr](index.html) module"]
