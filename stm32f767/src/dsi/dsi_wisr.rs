...
pub struct R(crate::R<DSI_WISR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<DSI_WISR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<DSI_WISR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<DSI_WISR_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "DSI Wrapper Interrupt & Status Register\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [dsi_wisr](index.html) module"]
pub struct DSI_WISR_SPEC;
impl crate::RegisterSpec for DSI_WISR_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [dsi_wisr::R](R) reader structure"]
impl crate::Readable for DSI_WISR_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets DSI_WISR to value 0"]
impl crate::Resettable for DSI_WISR_SPEC {
    #[inline(always)]
