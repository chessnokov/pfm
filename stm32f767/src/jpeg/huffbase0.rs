#[doc = "Register `HUFFBASE0` reader"]
pub struct R(crate::R<HUFFBASE0_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<HUFFBASE0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<HUFFBASE0_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<HUFFBASE0_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `HUFFBASE0` writer"]
pub struct W(crate::W<HUFFBASE0_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<HUFFBASE0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<HUFFBASE0_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<HUFFBASE0_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "JPEG HuffSymb tables\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [huffbase0](index.html) module"]
pub struct HUFFBASE0_SPEC;
impl crate::RegisterSpec for HUFFBASE0_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [huffbase0::R](R) reader structure"]
impl crate::Readable for HUFFBASE0_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [huffbase0::W](W) writer structure"]
impl crate::Writable for HUFFBASE0_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets HUFFBASE0 to value 0"]
impl crate::Resettable for HUFFBASE0_SPEC {
    #[inline(always)]
