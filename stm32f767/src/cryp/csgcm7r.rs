...
pub struct CSGCM7R_R(crate::FieldReader<u32, u32>);
impl CSGCM7R_R {
    #[inline(always)]
    pub(crate) fn new(bits: u32) -> Self {
        CSGCM7R_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for CSGCM7R_R {
...
impl W {
    #[doc = "Bits 0:31 - CSGCM7R"]
    #[inline(always)]
    pub fn csgcm7r(&mut self) -> CSGCM7R_W {
        CSGCM7R_W { w: self }
    }
