...
pub struct R(crate::R<DSI_ISR0_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<DSI_ISR0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<DSI_ISR0_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<DSI_ISR0_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "DSI Host Interrupt & Status Register 0\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [dsi_isr0](index.html) module"]
