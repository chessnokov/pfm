...
pub struct R(crate::R<DSI_VVBPCCR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<DSI_VVBPCCR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<DSI_VVBPCCR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<DSI_VVBPCCR_SPEC>) -> Self {
        R(reader)
    }
}
