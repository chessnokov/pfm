...
pub struct R(crate::R<OTG_HS_DVBUSDIS_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<OTG_HS_DVBUSDIS_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<OTG_HS_DVBUSDIS_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<OTG_HS_DVBUSDIS_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `OTG_HS_DVBUSDIS` writer"]
pub struct W(crate::W<OTG_HS_DVBUSDIS_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<OTG_HS_DVBUSDIS_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<OTG_HS_DVBUSDIS_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<OTG_HS_DVBUSDIS_SPEC>) -> Self {
        W(writer)
    }
}
