...
pub struct R(crate::R<DSI_LPCR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<DSI_LPCR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<DSI_LPCR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<DSI_LPCR_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `DSI_LPCR` writer"]
pub struct W(crate::W<DSI_LPCR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<DSI_LPCR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<DSI_LPCR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<DSI_LPCR_SPEC>) -> Self {
        W(writer)
    }
}
