...
pub struct W(crate::W<MDIOS_DOUTR11_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<MDIOS_DOUTR11_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<MDIOS_DOUTR11_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<MDIOS_DOUTR11_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `DOUT11` reader - Output data sent to MDIO Master during read frames"]
pub struct DOUT11_R(crate::FieldReader<u16, u16>);
impl DOUT11_R {
    #[inline(always)]
...
impl crate::Writable for MDIOS_DOUTR11_SPEC {
    type Writer = W;
}
