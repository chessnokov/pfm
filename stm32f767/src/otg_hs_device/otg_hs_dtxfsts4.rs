...
pub struct R(crate::R<OTG_HS_DTXFSTS4_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<OTG_HS_DTXFSTS4_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<OTG_HS_DTXFSTS4_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<OTG_HS_DTXFSTS4_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "OTG_HS device IN endpoint transmit FIFO status register\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [otg_hs_dtxfsts4](index.html) module"]
pub struct OTG_HS_DTXFSTS4_SPEC;
impl crate::RegisterSpec for OTG_HS_DTXFSTS4_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [otg_hs_dtxfsts4::R](R) reader structure"]
impl crate::Readable for OTG_HS_DTXFSTS4_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets OTG_HS_DTXFSTS4 to value 0"]
impl crate::Resettable for OTG_HS_DTXFSTS4_SPEC {
    #[inline(always)]
