...
pub struct CSGCMCCM1R_R(crate::FieldReader<u32, u32>);
impl CSGCMCCM1R_R {
    #[inline(always)]
    pub(crate) fn new(bits: u32) -> Self {
        CSGCMCCM1R_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for CSGCMCCM1R_R {
...
pub struct CSGCMCCM1R_W<'a> {
    w: &'a mut W,
}
impl<'a> CSGCMCCM1R_W<'a> {
...
impl W {
    #[doc = "Bits 0:31 - CSGCMCCM1R"]
    #[inline(always)]
    pub fn csgcmccm1r(&mut self) -> CSGCMCCM1R_W {
        CSGCMCCM1R_W { w: self }
    }
