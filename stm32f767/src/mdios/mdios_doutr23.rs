...
pub struct W(crate::W<MDIOS_DOUTR23_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<MDIOS_DOUTR23_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<MDIOS_DOUTR23_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<MDIOS_DOUTR23_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `DOUT23` reader - Output data sent to MDIO Master during read frames"]
pub struct DOUT23_R(crate::FieldReader<u16, u16>);
impl DOUT23_R {
    #[inline(always)]
    pub(crate) fn new(bits: u16) -> Self {
        DOUT23_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for DOUT23_R {
...
impl crate::Writable for MDIOS_DOUTR23_SPEC {
    type Writer = W;
}
