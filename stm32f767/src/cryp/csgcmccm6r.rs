...
pub struct CSGCMCCM6R_R(crate::FieldReader<u32, u32>);
impl CSGCMCCM6R_R {
    #[inline(always)]
    pub(crate) fn new(bits: u32) -> Self {
        CSGCMCCM6R_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for CSGCMCCM6R_R {
...
pub struct CSGCMCCM6R_W<'a> {
    w: &'a mut W,
}
impl<'a> CSGCMCCM6R_W<'a> {
...
impl W {
    #[doc = "Bits 0:31 - CSGCMCCM6R"]
    #[inline(always)]
    pub fn csgcmccm6r(&mut self) -> CSGCMCCM6R_W {
        CSGCMCCM6R_W { w: self }
    }
