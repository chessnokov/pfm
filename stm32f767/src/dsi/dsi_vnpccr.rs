...
pub struct R(crate::R<DSI_VNPCCR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<DSI_VNPCCR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<DSI_VNPCCR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<DSI_VNPCCR_SPEC>) -> Self {
        R(reader)
    }
}
