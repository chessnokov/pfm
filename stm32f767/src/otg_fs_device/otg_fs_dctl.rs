...
pub struct R(crate::R<OTG_FS_DCTL_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<OTG_FS_DCTL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<OTG_FS_DCTL_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<OTG_FS_DCTL_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `OTG_FS_DCTL` writer"]
pub struct W(crate::W<OTG_FS_DCTL_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<OTG_FS_DCTL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<OTG_FS_DCTL_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<OTG_FS_DCTL_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "OTG_FS device control register (OTG_FS_DCTL)\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [otg_fs_dctl](index.html) module"]
pub struct OTG_FS_DCTL_SPEC;
impl crate::RegisterSpec for OTG_FS_DCTL_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [otg_fs_dctl::R](R) reader structure"]
impl crate::Readable for OTG_FS_DCTL_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [otg_fs_dctl::W](W) writer structure"]
impl crate::Writable for OTG_FS_DCTL_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets OTG_FS_DCTL to value 0"]
impl crate::Resettable for OTG_FS_DCTL_SPEC {
    #[inline(always)]
