#[doc = "Register `HUFFBASE16` reader"]
pub struct R(crate::R<HUFFBASE16_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<HUFFBASE16_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<HUFFBASE16_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<HUFFBASE16_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `HUFFBASE16` writer"]
pub struct W(crate::W<HUFFBASE16_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<HUFFBASE16_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<HUFFBASE16_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<HUFFBASE16_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "JPEG HuffSymb tables\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [huffbase16](index.html) module"]
pub struct HUFFBASE16_SPEC;
impl crate::RegisterSpec for HUFFBASE16_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [huffbase16::R](R) reader structure"]
impl crate::Readable for HUFFBASE16_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [huffbase16::W](W) writer structure"]
impl crate::Writable for HUFFBASE16_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets HUFFBASE16 to value 0"]
impl crate::Resettable for HUFFBASE16_SPEC {
    #[inline(always)]
