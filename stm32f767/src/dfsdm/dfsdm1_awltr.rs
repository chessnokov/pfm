#[doc = "Register `DFSDM1_AWLTR` reader"]
pub struct R(crate::R<DFSDM1_AWLTR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<DFSDM1_AWLTR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<DFSDM1_AWLTR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<DFSDM1_AWLTR_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `DFSDM1_AWLTR` writer"]
pub struct W(crate::W<DFSDM1_AWLTR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<DFSDM1_AWLTR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<DFSDM1_AWLTR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<DFSDM1_AWLTR_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "DFSDM analog watchdog low threshold register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [dfsdm1_awltr](index.html) module"]
pub struct DFSDM1_AWLTR_SPEC;
impl crate::RegisterSpec for DFSDM1_AWLTR_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [dfsdm1_awltr::R](R) reader structure"]
impl crate::Readable for DFSDM1_AWLTR_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [dfsdm1_awltr::W](W) writer structure"]
impl crate::Writable for DFSDM1_AWLTR_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets DFSDM1_AWLTR to value 0"]
impl crate::Resettable for DFSDM1_AWLTR_SPEC {
    #[inline(always)]
