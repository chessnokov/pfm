...
pub struct R(crate::R<DSI_PSR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<DSI_PSR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<DSI_PSR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<DSI_PSR_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "DSI Host PHY Status Register\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [dsi_psr](index.html) module"]
...
#[doc = "`reset()` method sets DSI_PSR to value 0"]
