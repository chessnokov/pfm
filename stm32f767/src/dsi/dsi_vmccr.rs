...
pub struct R(crate::R<DSI_VMCCR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<DSI_VMCCR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<DSI_VMCCR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<DSI_VMCCR_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "DSI Host Video mode Current Configuration Register\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [dsi_vmccr](index.html) module"]
pub struct DSI_VMCCR_SPEC;
impl crate::RegisterSpec for DSI_VMCCR_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [dsi_vmccr::R](R) reader structure"]
impl crate::Readable for DSI_VMCCR_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets DSI_VMCCR to value 0"]
impl crate::Resettable for DSI_VMCCR_SPEC {
    #[inline(always)]
