...
pub struct R(crate::R<DSI_VMCR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<DSI_VMCR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<DSI_VMCR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<DSI_VMCR_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `DSI_VMCR` writer"]
pub struct W(crate::W<DSI_VMCR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<DSI_VMCR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<DSI_VMCR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<DSI_VMCR_SPEC>) -> Self {
        W(writer)
    }
}
