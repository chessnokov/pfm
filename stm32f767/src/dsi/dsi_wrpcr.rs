...
pub struct R(crate::R<DSI_WRPCR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<DSI_WRPCR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<DSI_WRPCR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<DSI_WRPCR_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `DSI_WRPCR` writer"]
pub struct W(crate::W<DSI_WRPCR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<DSI_WRPCR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<DSI_WRPCR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<DSI_WRPCR_SPEC>) -> Self {
        W(writer)
    }
}
