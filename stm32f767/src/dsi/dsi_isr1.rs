...
pub struct R(crate::R<DSI_ISR1_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<DSI_ISR1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<DSI_ISR1_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<DSI_ISR1_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "DSI Host Interrupt & Status Register 1\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [dsi_isr1](index.html) module"]
pub struct DSI_ISR1_SPEC;
impl crate::RegisterSpec for DSI_ISR1_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [dsi_isr1::R](R) reader structure"]
impl crate::Readable for DSI_ISR1_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets DSI_ISR1 to value 0"]
impl crate::Resettable for DSI_ISR1_SPEC {
    #[inline(always)]
