#[doc = "Register `HUFFBASE23` reader"]
pub struct R(crate::R<HUFFBASE23_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<HUFFBASE23_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<HUFFBASE23_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<HUFFBASE23_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `HUFFBASE23` writer"]
pub struct W(crate::W<HUFFBASE23_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<HUFFBASE23_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<HUFFBASE23_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<HUFFBASE23_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "JPEG HuffSymb tables\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [huffbase23](index.html) module"]
pub struct HUFFBASE23_SPEC;
impl crate::RegisterSpec for HUFFBASE23_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [huffbase23::R](R) reader structure"]
impl crate::Readable for HUFFBASE23_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [huffbase23::W](W) writer structure"]
impl crate::Writable for HUFFBASE23_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets HUFFBASE23 to value 0"]
impl crate::Resettable for HUFFBASE23_SPEC {
    #[inline(always)]
