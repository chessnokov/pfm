...
pub struct R(crate::R<DSI_GPSR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<DSI_GPSR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<DSI_GPSR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<DSI_GPSR_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "DSI Host Generic Packet Status Register\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [dsi_gpsr](index.html) module"]
...
#[doc = "`reset()` method sets DSI_GPSR to value 0"]
