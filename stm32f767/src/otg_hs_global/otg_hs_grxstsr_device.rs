...
pub struct R(crate::R<OTG_HS_GRXSTSR_DEVICE_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<OTG_HS_GRXSTSR_DEVICE_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<OTG_HS_GRXSTSR_DEVICE_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<OTG_HS_GRXSTSR_DEVICE_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "OTG_HS Receive status debug read register (peripheral mode mode)\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [otg_hs_grxstsr_device](index.html) module"]
pub struct OTG_HS_GRXSTSR_DEVICE_SPEC;
impl crate::RegisterSpec for OTG_HS_GRXSTSR_DEVICE_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [otg_hs_grxstsr_device::R](R) reader structure"]
impl crate::Readable for OTG_HS_GRXSTSR_DEVICE_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets OTG_HS_GRXSTSR_Device to value 0"]
impl crate::Resettable for OTG_HS_GRXSTSR_DEVICE_SPEC {
    #[inline(always)]
